...
static void ma35d1_io_powerup_setup(void)
{
	INFO("ma35d1 User GPIO setup\n");	
	/* enable gpio clock - CLK_SYSCLK1[29:16] <=> PN:PA */
	mmio_write_32(0X40460208, mmio_read_32(0X40460208) | (1 << 27));	// En PL clock
	mmio_write_32(0X40460208, mmio_read_32(0X40460208) | (1 << 28));	// En PM clock
	mmio_write_32(0X40460208, mmio_read_32(0X40460208) | (1 << 20));	// En PE clock
	mmio_write_32(0X40460208, mmio_read_32(0X40460208) | (1 << 18));	// En PC clock
	mmio_write_32(0X40460208, mmio_read_32(0X40460208) | (1 << 29));	// En PN clock

	/* set MFP , function-4bits , ref ma35d1-pinfunc.h */
	mmio_write_32(0X404600DC, ((mmio_read_32(0X404600DC) & ~0xf0000000) | (0x0<<28))); // SYS_GPL_MFPH ; PL.15(LCD_PWM) GPIO Function
	mmio_write_32(0X404600E0, ((mmio_read_32(0X404600E0) & ~0x0f000000) | (0x0<<24))); // SYS_GPM_MFPL ; PM.6(LCD_CS) GPIO Function
	mmio_write_32(0X404600E0, ((mmio_read_32(0X404600E0) & ~0xf0000000) | (0x0<<28))); // SYS_GPM_MFPL ; PM.7(LCD_BLEN) GPIO Function
	mmio_write_32(0X404600A4, ((mmio_read_32(0X404600A4) & ~0x000f0000) | (0x0<<16))); // SYS_GPE_MFPH ; PE.12(BZ1) GPIO Function
	mmio_write_32(0X404600A4, ((mmio_read_32(0X404600A4) & ~0x00f00000) | (0x0<<20))); // SYS_GPE_MFPH ; PE.13(BZ2) GPIO Function
	mmio_write_32(0X40460090, ((mmio_read_32(0X40460090) & ~0xf0000000) | (0x0<<28))); // SYS_GPC_MFPL ; PC.7(LTE_RST) GPIO Function
	mmio_write_32(0X404600E8, ((mmio_read_32(0X404600E8) & ~0x000000f0) | (0x0<<04))); // SYS_GPN_MFPL ; PN.1(LTE_PWR) GPIO Function
	mmio_write_32(0X404600E8, ((mmio_read_32(0X404600E8) & ~0x0000000f) | (0x0<<00))); // SYS_GPN_MFPL ; PN.0(WIFI_PWR) GPIO Function

	/* set GPIO mode , mode-2bits , Bit[31:0] <=> mode15:0 */
	mmio_write_32(0x400402C0, 0x01 << 30); // PL_MODE ; PL.15 Push-pull Output mode 
	mmio_write_32(0x40040300, 0x05 << 12); // PM_MODE ; PM.6, PM.7 Push-pull Output mode 
	mmio_write_32(0x40040100, 0x05 << 24); // PE_MODE ; PE.12, PE.13 Push-pull Output mode 
	mmio_write_32(0x40040080, 0x01 << 14); // PC_MODE ; PC.7 Push-pull Output mode 
	mmio_write_32(0x40040340, 0x05 << 00); // PN_MODE ; PN.0, PN.1 Push-pull Output mode 
	INFO("ma35d1 User PL mode = [0x%08x]\n", mmio_read_32(0x400402C0));
	INFO("ma35d1 User PM mode = [0x%08x]\n", mmio_read_32(0x40040300));
	INFO("ma35d1 User PE mode = [0x%08x]\n", mmio_read_32(0x40040100));
	INFO("ma35d1 User PC mode = [0x%08x]\n", mmio_read_32(0x40040080));
	INFO("ma35d1 User PN mode = [0x%08x]\n", mmio_read_32(0x40040340));

	/* set GPIO DOUT , data-1bit , Bit0-16 */
	mmio_write_32(0x400402C8, ((mmio_read_32(0x400402C8) & ~0x00008000) | (0x0<<15))); // PL_DOUT ; PL.15(LCD_PWM) GPIO-L
	mmio_write_32(0x40040308, ((mmio_read_32(0x40040308) & ~0x00000040) | (0x1<<06))); // PM_DOUT ; PM.6(LCD_CS) GPIO-H
	mmio_write_32(0x40040308, ((mmio_read_32(0x40040308) & ~0x00000080) | (0x1<<07))); // PM_DOUT ; PM.7(LCD_BLEN) GPIO-H

	//mmio_write_32(0x40040108, ((mmio_read_32(0x40040108) & ~0x00001000) | (0x1<<12))); // PE_DOUT ; PE.12 GPIO-H
	//mmio_write_32(0x40040108, ((mmio_read_32(0x40040108) & ~0x00002000) | (0x1<<13))); // PE_DOUT ; PE.13 GPIO-H
	//mdelay(300);
	mmio_write_32(0x40040108, ((mmio_read_32(0x40040108) & ~0x00001000) | (0x0<<12))); // PE_DOUT ; PE.12 GPIO-L
	mmio_write_32(0x40040108, ((mmio_read_32(0x40040108) & ~0x00002000) | (0x0<<13))); // PE_DOUT ; PE.13 GPIO-L

	mmio_write_32(0x40040088, ((mmio_read_32(0x40040088) & ~0x00000080) | (0x1<<07))); // PC_DOUT ; PC.7 GPIO-H
	mmio_write_32(0x40040348, ((mmio_read_32(0x40040348) & ~0x00000002) | (0x1<<01))); // PN_DOUT ; PN.1 GPIO-H
	mmio_write_32(0x40040348, ((mmio_read_32(0x40040348) & ~0x00000001) | (0x0<<00))); // PN_DOUT ; PN.0 GPIO-L
	INFO("ma35d1 User PL_DOUT = [0x%08x]\n", mmio_read_32(0x400402C8));
	INFO("ma35d1 User PM_DOUT = [0x%08x]\n", mmio_read_32(0x40040308));
	INFO("ma35d1 User PE_DOUT = [0x%08x]\n", mmio_read_32(0x40040108));
	INFO("ma35d1 User PC_DOUT = [0x%08x]\n", mmio_read_32(0x40040088));
	INFO("ma35d1 User PN_DOUT = [0x%08x]\n", mmio_read_32(0x40040348));
}
